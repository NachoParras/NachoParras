...
#2. Read the dataset and make a list with selected genes 
...
#ggsave(filename = paste0(opt$output,"/venny_results.",opt$output_format, sep = "")
dev.off()
